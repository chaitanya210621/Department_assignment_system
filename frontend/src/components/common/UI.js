...
export const Alert = ({ type = 'info', message, onClose }) => {
  ...
  return (
    <div className={`flex items-start gap-3 p-4 border rounded-lg animate-fade-in ${styles[type]}`}>
      <span className="flex-shrink-0 mt-0.5">{icons[type]}</span>
      <p className="text-sm flex-1">{message}</p>
      {onClose && (
        <button onClick={onClose} className="flex-shrink-0 ml-auto opacity-60 hover:opacity-100">
